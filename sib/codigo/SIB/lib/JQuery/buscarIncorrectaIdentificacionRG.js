...
$(document).ready(function () {
    ...
    $("#tableIncorrectaIdentificacionrRG").tablesorter();
    ...
    $("#contenido").on("click", "#btnBuscarIncorrectaIdentificacion", function () {
        $.ajax({
            type: "POST",
            url: "procesarBuscarIncorrectaIdentificacionRG.php",
            ...
            success: function (data) {
                ...
                $('#tb_buscar_incorrecta').DataTable({
                    ...
                    buttons: [
                        {   extend: 'excelHtml5',
                            title: 'Incorrecta identificacion de clientes - Sucursal Rio Gallegos'
                        },
                        {   extend: 'pdfHtml5',
                            title: 'Incorrecta identificacion de clientes - Sucursal Rio Gallegos',
