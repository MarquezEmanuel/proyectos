...
$(document).ready(function () {
    ...
    $("#tableIncorrectaIdentificacionrBA").tablesorter();
    ...
    $("#contenido").on("click", "#btnBuscarIncorrectaIdentificacion", function () {
        $.ajax({
            type: "POST",
            url: "procesarBuscarIncorrectaIdentificacionBA.php",
            ...
            success: function (data) {
                ...
                $('#tb_buscar_incorrecta').DataTable({
                    ...
                    buttons: [
                        {   extend: 'excelHtml5',
                            title: 'Incorrecta identificacion de clientes - Sucursal Buenos Aires'
                        },
                        {   extend: 'pdfHtml5',
                            title: 'Incorrecta identificacion de clientes - Sucursal Buenos Aires',
