            ...
            <div class="container">
                ...
                <div class="form-row align-items-center mx-auto">
                    ...
                    <div class="col-lg-8 text-center">
                        <a href="saldos.php"><input type="button" class="btn btn-lg btn-dark btn-block" id="" name="" value="Ver Saldos contables diarios de la fecha"></a>
                    </div>
                    <div class="col-lg-2 text-center">
                    </div>
                </div>
                ...
                <div class="form-row align-items-center mx-auto">
                    ...
                    <div class="col-lg-8 text-center">
                        <a href="buscarSaldos.php"><input type="button" class="btn btn-lg btn-dark btn-block" id="" name="" value="Buscar Saldos contables diarios"></a>
                    </div>
                    <div class="col-lg-2 text-center">
                    </div>
                </div>
