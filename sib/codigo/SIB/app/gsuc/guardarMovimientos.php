...
$sql = "UPDATE [3movimientoSinDepositantes] SET comentario = '$comentario' WHERE id = " . $idCuenta;
            ...
            <div class="container">
                ...
                <div class="form-row align-items-center mx-auto">
                    ...
                    <div class="col-lg-8 text-center">
                        <a href="movimientosSinDepositantes.php"><input type="button" class="btn btn-lg btn-dark btn-block" id="" name="" value="Ver Movimientos sin depositantes de la fecha"></a>
                    </div>
                    <div class="col-lg-2 text-center">
                    </div>
                </div>
                ...
                <div class="form-row align-items-center mx-auto">
                    ...
                    <div class="col-lg-8 text-center">
                        <a href="buscarMovimientosSinDepositantes.php"><input type="button" class="btn btn-lg btn-dark btn-block" id="" name="" value="Buscar Movimientos sin depositantes"></a>
                    </div>
                    <div class="col-lg-2 text-center">
                    </div>
                </div>
