            ...
            <div class="container">
                ...
                <div class="form-row align-items-center mx-auto">
                    ...
                    <div class="col-lg-8 text-center">
                        <a href="telefonosTarjetas.php"><input type="button" class="btn btn-lg btn-dark btn-block" id="" name="" value="Ver Datos de Clientes con tarjetas en el tesoro de la fecha"></a>
                    </div>
                    <div class="col-lg-2 text-center">
                    </div>
                </div>
                ...
                <div class="form-row align-items-center mx-auto">
                    ...
                    <div class="col-lg-8 text-center">
                        <a href="buscarTelefonosTarjetas.php.php"><input type="button" class="btn btn-lg btn-dark btn-block" id="" name="" value="Buscar Datos de Clientes con tarjetas en el tesoro"></a>
                    </div>
                    <div class="col-lg-2 text-center">
                    </div>
                </div>
