...
function noSAV() {
    ...
    $sql = "SELECT count(*)cantidad FROM [3pagaresCancelados] WHERE codigoSucursalDeposito = 1 AND fechaActualizacion between '{$actual}' AND '{$actualfinal}'";
    ...
    if ($result) {
        ...
        if ($filas) {
            ...
            $html = $html."<tr> <td COLSPAN=3>No hay pagares cancelados en SAV en la fecha en Rio Gallegos</td></tr>";
        }
    } else {
        $html = $html."<tr> <td COLSPAN=3>No hay pagares cancelados en SAV en la fecha en Rio Gallegos</td></tr>";
    }
    ...
    $sql = "SELECT count(*)cantidad FROM [3pagaresCancelados] WHERE codigoSucursalDeposito = 5 AND fechaActualizacion between '{$actual}' AND '{$actualfinal}'";
    $result = sqlsrv_query(BDConexion::getInstancia()->getConexion(), $sql);
    if ($result) {
        $filas = sqlsrv_has_rows($result);
        if ($filas) {
            ...
            $html = $html."<tr> <td COLSPAN=3>No hay pagares cancelados en SAV en la fecha en Buenos Aires</td></tr>";
        }
    } else {
        $html = $html."<tr> <td COLSPAN=3>No hay pagares cancelados en SAV en la fecha en Buenos Aires</td></tr>";
    }
    ...
    $sql = "SELECT count(*)cantidad FROM [3pagaresCancelados] WHERE codigoSucursalDeposito = 10 AND fechaActualizacion between '{$actual}' AND '{$actualfinal}'";
    $result = sqlsrv_query(BDConexion::getInstancia()->getConexion(), $sql);
    if ($result) {
        $filas = sqlsrv_has_rows($result);
        if ($filas) {
    ...
    $sql = "SELECT count(*)cantidad FROM [3pagaresCancelados] WHERE codigoSucursalDeposito = 15 AND fechaActualizacion between '{$actual}' AND '{$actualfinal}'";
    $result = sqlsrv_query(BDConexion::getInstancia()->getConexion(), $sql);
    if ($result) {
        $filas = sqlsrv_has_rows($result);
        if ($filas) {
    ...
    $sql = "SELECT count(*)cantidad FROM [3pagaresCancelados] WHERE codigoSucursalDeposito = 20 AND fechaActualizacion between '{$actual}' AND '{$actualfinal}'";
    $result = sqlsrv_query(BDConexion::getInstancia()->getConexion(), $sql);
    if ($result) {
        $filas = sqlsrv_has_rows($result);
        if ($filas) {
    ...
    $sql = "SELECT count(*)cantidad FROM [3pagaresCancelados] WHERE codigoSucursalDeposito = 25 AND fechaActualizacion between '{$actual}' AND '{$actualfinal}'";
    $result = sqlsrv_query(BDConexion::getInstancia()->getConexion(), $sql);
    if ($result) {
        $filas = sqlsrv_has_rows($result);
        if ($filas) {
    ...
    $sql = "SELECT count(*)cantidad FROM [3pagaresCancelados] WHERE codigoSucursalDeposito = 30 AND fechaActualizacion between '{$actual}' AND '{$actualfinal}'";
    $result = sqlsrv_query(BDConexion::getInstancia()->getConexion(), $sql);
    if ($result) {
        $filas = sqlsrv_has_rows($result);
        if ($filas) {
    ...
    $sql = "SELECT count(*)cantidad FROM [3pagaresCancelados] WHERE codigoSucursalDeposito = 40 AND fechaActualizacion between '{$actual}' AND '{$actualfinal}'";
    $result = sqlsrv_query(BDConexion::getInstancia()->getConexion(), $sql);
    if ($result) {
        $filas = sqlsrv_has_rows($result);
        if ($filas) {
    ...
    $sql = "SELECT count(*)cantidad FROM [3pagaresCancelados] WHERE codigoSucursalDeposito = 41 AND fechaActualizacion between '{$actual}' AND '{$actualfinal}'";
    $result = sqlsrv_query(BDConexion::getInstancia()->getConexion(), $sql);
    if ($result) {
        $filas = sqlsrv_has_rows($result);
        if ($filas) {
    ...
    $sql = "SELECT count(*)cantidad FROM [3pagaresCancelados] WHERE codigoSucursalDeposito = 45 AND fechaActualizacion between '{$actual}' AND '{$actualfinal}'";
    $result = sqlsrv_query(BDConexion::getInstancia()->getConexion(), $sql);
    if ($result) {
        $filas = sqlsrv_has_rows($result);
        if ($filas) {
    ...
    $sql = "SELECT count(*)cantidad FROM [3pagaresCancelados] WHERE codigoSucursalDeposito = 50 AND fechaActualizacion between '{$actual}' AND '{$actualfinal}'";
    $result = sqlsrv_query(BDConexion::getInstancia()->getConexion(), $sql);
    if ($result) {
        $filas = sqlsrv_has_rows($result);
        if ($filas) {
    ...
    $sql = "SELECT count(*)cantidad FROM [3pagaresCancelados] WHERE codigoSucursalDeposito = 55 AND fechaActualizacion between '{$actual}' AND '{$actualfinal}'";
    $result = sqlsrv_query(BDConexion::getInstancia()->getConexion(), $sql);
    if ($result) {
        $filas = sqlsrv_has_rows($result);
        if ($filas) {
    ...
    $sql = "SELECT count(*)cantidad FROM [3pagaresCancelados] WHERE codigoSucursalDeposito = 60 AND fechaActualizacion between '{$actual}' AND '{$actualfinal}'";
    $result = sqlsrv_query(BDConexion::getInstancia()->getConexion(), $sql);
    if ($result) {
        $filas = sqlsrv_has_rows($result);
        if ($filas) {
    ...
    $sql = "SELECT count(*)cantidad FROM [3pagaresCancelados] WHERE codigoSucursalDeposito = 70 AND fechaActualizacion between '{$actual}' AND '{$actualfinal}'";
    $result = sqlsrv_query(BDConexion::getInstancia()->getConexion(), $sql);
    if ($result) {
        $filas = sqlsrv_has_rows($result);
        if ($filas) {
    ...
    $sql = "SELECT count(*)cantidad FROM [3pagaresCancelados] WHERE codigoSucursalDeposito = 80 AND fechaActualizacion between '{$actual}' AND '{$actualfinal}'";
    $result = sqlsrv_query(BDConexion::getInstancia()->getConexion(), $sql);
    if ($result) {
        $filas = sqlsrv_has_rows($result);
        if ($filas) {
    ...
    $sql = "SELECT count(*)cantidad FROM [3pagaresCancelados] WHERE codigoSucursalDeposito = 85 AND fechaActualizacion between '{$actual}' AND '{$actualfinal}'";
    $result = sqlsrv_query(BDConexion::getInstancia()->getConexion(), $sql);
    if ($result) {
        $filas = sqlsrv_has_rows($result);
        if ($filas) {
