...
function cuentaCorrentista() {
    ...
    $sql = "select *
	from [bd_sib].[dbo].[3archivosConta] WHERE fechaActualizacion between '{$actual}' AND '{$actualfinal}' AND sucursal = {$sucursal}";
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div id="contenido" name="contenido" class="col-lg-12 contenido1">
						<br>
                        <a href="archivosContaSucursales.php"><input type="button" class="btn btn-dark" id="" name="" value="Volver"></a>
                        <div class="center">
