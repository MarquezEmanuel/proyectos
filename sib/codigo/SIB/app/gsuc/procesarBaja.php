...
if ($id) {
    $sql = "DELETE [3cuentasConstanciaSaldo] WHERE id =" . $id;
...
if ($elimina) {
    ...
    function mensaje(){
    $html = '
                        <h1><u>Cuenta eliminada con exito</u></h1>
    ...
    function mensaje(){
    $html = '
                        <div class=alert-danger><h2 class=text-center>Ocurrio Un Error Al Eliminar la Cuenta</h2></div>
						<h3 class="h3 mb-3 font-weight-normal text-blue">Seleccione una opcion:</h3>';
    return $html;
	}
}
