                ...
                <div class="row">
                    <div class="col">
                        <div class="text-center">
                            ...
                            &nbsp;
                            <a href="buscarSaldos.php"><input type="button" class="btn btn-dark" id="" name="" value="Cancelar"></a>
                             &nbsp;
                             <a href="saldos.php"><input type="button" class="btn btn-dark" id="" name="" value="Volver"></a>
                        </div>
                    </div>
                </div>
            </form>
