    ...
    <div id="contenido">
        ...
        <div id="centro" class="container">
            ...
            if (!$idCuenta || !$result) {
                ...
                $fecha = "";
                $fecha = isset($cuen['fechaAlta']) ? $cuen['fechaAlta']->format('d/m/Y') : "";
				...
				$sql2 = "select * from openquery(M4000SF,'select ANO_LARGA from SFB_BSMTG MTG
							...
							WHERE MTG.ACO_CODIG <> '' '' AND MTG.ACO_TABLA = ''ESTCLIEN'' AND MCL.SCO_IDENT = {$cuen['nroCliente']}')";
            ...
            <form action="guardarClientesPotenciales.php" method="post">
                <div class="container">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="w-100"></div>
						<label for="producto" class="col-sm-2 col-form-label">Documento:</label>
                        <div class="col">
                            <input type="number" class="form-control mb-2" value="<?= $cuen['documento']; ?>" readonly>
                        </div>
						...
						<div class="w-100"></div>
						<label for="cuenta" class="col-sm-2 col-form-label">Estado:</label>
                        <div class="col">
                            <input type="text" class="form-control mb-2"  value="<?= $row2['ANO_LARGA']; ?>" readonly>
                        </div>
