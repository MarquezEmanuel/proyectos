            ...
            <div class="container">
                ...
                <div class="form-row align-items-center mx-auto">
                    ...
                    <div class="col-lg-8 text-center">
                        <a href="morasCPD.php"><input type="button" class="btn btn-lg btn-dark btn-block" id="" name="" value="Ver Moras en operaciones CPD de la fecha"></a>
                    </div>
                    <div class="col-lg-2 text-center">
                    </div>
                </div>
                ...
                <div class="form-row align-items-center mx-auto">
                    ...
                    <div class="col-lg-8 text-center">
                        <a href="buscarMorasCPD.php"><input type="button" class="btn btn-lg btn-dark btn-block" id="" name="" value="Buscar Moras en operaciones CPD de la fecha"></a>
                    </div>
                    <div class="col-lg-2 text-center">
                    </div>
                </div>
