            ...
            <div class="container">
                ...
                <div class="form-row align-items-center mx-auto">
                    ...
                    <div class="col-lg-8 text-center">
                        <a href="incorrectaIdentificacion.php"><input type="button" class="btn btn-lg btn-dark btn-block" id="" name="" value="Ver Incorrecta identificacion de clientes de la fecha"></a>
                    </div>
                    <div class="col-lg-2 text-center">
                    </div>
                </div>
                ...
                <div class="form-row align-items-center mx-auto">
                    ...
                    <div class="col-lg-8 text-center">
                        <a href="buscarIncorrectaIdentificacion.php"><input type="button" class="btn btn-lg btn-dark btn-block" id="" name="" value="Buscar Incorrecta identificacion de clientes"></a>
                    </div>
                    <div class="col-lg-2 text-center">
                    </div>
                </div>
