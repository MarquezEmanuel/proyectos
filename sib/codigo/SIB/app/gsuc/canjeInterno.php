...
function canjeInterno() {
    ...
    $sql = "SELECT *,convert(varchar,cast(importe as money),1) AS importe2 FROM [3canjeInterno] WHERE fechaActualizacion between '{$actual}' AND '{$actualfinal}'";
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div id="contenido" name="contenido" class="col-lg-12 contenido1">
                        ...
                        <br>
                        <a href="buscarCanjeInterno.php"><input type="button" class="btn btn-dark" id="" name="" value="Busqueda Avanzada"></a>
                        &nbsp;
                        <a href="reportesTablas.php"><input type="button" class="btn btn-dark" id="" name="" value="Volver"></a>
                        <br><br>
                        <div class="form-row align-items-center mx-auto">
                            <table id='diariosCanjeInterno' class='table table-striped table-bordered' border="3" style="width: 100%">
                                <colgroup>
                                    <col style='width: 23%'/>
                                    <col style='width: 23%'/>
                                    <col style='width: 23%'/>
