...
<html id="html">
    <head>
		...
		<link rel="stylesheet" href="../../lib/css/cargando.css">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
						<a href="../salaChat.php"><input type="button" class="btn btn-secondary my-2 my-sm-0" value="CHAT"></a>
                    </ul>
