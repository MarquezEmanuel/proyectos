            ...
            <form id="formBuscarCanje" name="formBuscarCanje" method="POST">
                <div class="row">
                    <div class="col">
                        ...
                        <select name="sucursal" id="sucursal" class="form-control mb-2" title="Estado">
								<?=$print; ?>
							</select>
                    </div>
                    <div class="col">
                        <label for="comentario" class="col-sm-2 col-form-label">Saldo:</label>
                        <div class="col" >
                ...
                <div class="row">
                    <div class="col">
                        <div class="text-center">
							...
							&nbsp;
							<a href="archivosContaSucursales.php"><input type="button" class="btn btn-dark" id="" name="" value="Archivos Generados"></a>
                            &nbsp;
