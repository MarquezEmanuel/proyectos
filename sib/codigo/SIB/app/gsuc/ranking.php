...
function ranking() {
    ...
    $sql = "SELECT usuario,count(usuario)cantidad FROM [3reversas] GROUP BY usuario ORDER BY cantidad DESC";
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div id="contenido" name="contenido" class="col-lg-12 contenido1">
                        <div class="center">
                            <h3 class="text-center"><u>Ranking Reversas</u></h3>
                        </div>
                        <br>
                        <a href="buscarReversas.php"><input type="button" class="btn btn-dark" id="" name="" value="Busqueda Avanzada"></a>
                        &nbsp;
                        <a href="reversas.php"><input type="button" class="btn btn-dark" id="" name="" value="Volver"></a>
                        <br><br>
