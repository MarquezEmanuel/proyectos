...
<div class="container">
    <div id="contenido">
        <h3 class="text-center"><u>Detalles Plazo Fijo Vigente</u></h3>
        <div id="centro" class="container">
            <?php
            /* Se obtiene el id para obtener los datos de la BD */
            $cliente = $_POST['seleccionado'];
            $query = "SELECT *, convert(varchar,cast(montoDepositado as money),1) AS montoDepositado2,convert(varchar,cast(montoInteres as money),1) AS montoInteres2,convert(varchar,cast(montoPago as money),1) AS montoPago2 FROM [bd_sib].[dbo].[6plazosFijos] WHERE numeroCliente ='". $cliente ."'";
            ...
            if (!$cliente || !$result) {
				...
				$fechaOperacion = isset($row['fechaOperacion']) ? $row['fechaOperacion']->format('d/m/Y') : "";
					$html = $html .'
					<div class="container">
					<br>
