...
<div class="card-header">
    <div id="contenido">
        <h3 class="text-center"><u>Buscar Cliente</u></h3>
        <br>
        <div id="centro" class="container">
            <form id="formBuscarUnificado" name="formBuscarUnificado" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <label class="mr-sm-2">Bloqueos:</label> <br>
                        <input type="radio" name="embargo" value="IS NOT NULL"> <label class="mr-sm-2">Posee</label>
						<input type="radio" name="embargo" value="IS NULL"> <label class="mr-sm-2">No Posee</label>
                    </div>
					<div class="col">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="text-center">
                            ...
                            &nbsp;
                            <a href="buscarExcel.php"><input type="button" class="btn btn-dark" id="" name="" value="Cancelar"></a>
                            &nbsp;
...
<script type="text/javascript" charset="utf8">
    $(document).ready(function () {
		...
		$('#tb_buscar_unificado').DataTable({
                        ...
                        buttons: [
                            {extend: 'excelHtml5',
                                title: 'Informe Integrador de Banca Empresa'
                            },
                        ],
