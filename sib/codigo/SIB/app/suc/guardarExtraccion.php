...
if ($consulta) {
    ...
    $log = new Log();
    $log->writeLine("[Error al guardar comentario de extracciones por caja en forma manual][QUERY: $sql]");
    function mensaje() {
        $html = '
            ...
            <div class="container">
                ...
                <div class="form-row align-items-center mx-auto">
                    ...
                    <div class="col-lg-8 text-center">
                        <a href="formExtraccionesMayores.php"><input type="button" class="btn btn-lg btn-dark btn-block" id="" name="" value="Ver Extracciones por caja de la fecha"></a>
                    </div>
                    <div class="col-lg-2 text-center">
                    </div>
                </div>
                ...
                <div class="form-row align-items-center mx-auto">
                    ...
                    <div class="col-lg-8 text-center">
                        <a href="formBuscarExtracciones.php"><input type="button" class="btn btn-lg btn-dark btn-block" id="" name="" value="Buscar Extracciones por caja"></a>
                    </div>
                    <div class="col-lg-2 text-center">
                    </div>
                </div>
