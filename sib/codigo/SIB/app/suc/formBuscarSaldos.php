...
<div class="card-header">
    <div id="contenido">
        ...
        <div id="centro" class="container">
            <form id="formBuscarSaldos" name="formBuscarSaldos" method="POST">
                <div class="row">
                    <div class="col">
                ...
                <div class="row">
                    <div class="col">
                        <div class="text-center">
                            <input type="submit" class="btn btn-dark" id="btnBuscarSaldos" name="btnBuscarSaldos" value="Buscar" class="btn btn-bsc mt-4">
                            &nbsp;
                            <a href="formBuscarSaldos.php"><input type="button" class="btn btn-dark" id="" name="" value="Cancelar"></a>
                             &nbsp;
                             <a href="formSaldos.php"><input type="button" class="btn btn-dark" id="" name="" value="Volver"></a>
                        </div>
                    </div>
                </div>
            </form>
