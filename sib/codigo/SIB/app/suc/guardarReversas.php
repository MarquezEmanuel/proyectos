...
$sql = "UPDATE [3reversas] SET comentario = '$comentario' WHERE id = " . $idCuenta;
...
if ($consulta) {
    ...
    $log = new Log();
    $log->writeLine("[Error al guardar comentario de reversas en forma manual][QUERY: $sql]");
    function mensaje() {
        $html = '
            ...
            <div class="container">
                ...
                <div class="form-row align-items-center mx-auto">
                    ...
                    <div class="col-lg-8 text-center">
                        <a href="formReversas.php"><input type="button" class="btn btn-lg btn-dark btn-block" id="" name="" value="Ver Reversas de la fecha"></a>
                    </div>
                    <div class="col-lg-2 text-center">
                    </div>
                </div>
                ...
                <div class="form-row align-items-center mx-auto">
                    ...
                    <div class="col-lg-8 text-center">
                        <a href="formBuscarReversas.php"><input type="button" class="btn btn-lg btn-dark btn-block" id="" name="" value="Buscar Reversas"></a>
                    </div>
                    <div class="col-lg-2 text-center">
                    </div>
                </div>
