...
<div class="card-header">
    <div id="contenido">
        ...
        <div id="centro" class="container">
            <form id="formBuscarMoras" name="formBuscarMoras" method="POST">
                <div class="row">
                    <div class="col">
                ...
                <div class="row">
                    <div class="col">
                        <div class="text-center">
                            <input type="submit" class="btn btn-dark" id="btnBuscarMoras" name="btnBuscarMoras" value="Buscar" class="btn btn-bsc mt-4">
                            &nbsp;
                            <a href="formBuscarMorasCPD.php"><input type="button" class="btn btn-dark" id="" name="" value="Cancelar"></a>
                            &nbsp;
                            <a href="formMorasCPD.php"><input type="button" class="btn btn-dark" id="" name="" value="Volver"></a>
                        </div>
                    </div>
                </div>
            </form>
...
$(document).ready(function () {
    ...
    $("#contenido").on("click", "#btnBuscarMoras", function () {
        $.ajax({
            type: "POST",
            url: "procesarBuscarMoras.php",
            data: $("#formBuscarMoras").serialize(),
			beforeSend: function() {
    ...
    $("#contenido2").on("click", "img.detallesMoras", function () {
         var idcanje = $(this).attr('name');
         $.ajax({
            type: "POST",
            url: "formDetallesMorasCPD.php",
    ...
    $("#contenido").on("click", "img.detallesMoras2", function () {
         var idcanje = $(this).attr('name');
         $.ajax({
            type: "POST",
            url: "formDetallesMorasCPD.php",
