...
$query = "SELECT *,convert(varchar,cast(monto as money),1) AS monto2 FROM [3transaccionIncorrecta] WHERE sucursal = {$_SESSION['sucursal']} ";

if (isset($transaccion) && $transaccion != null) {
    $query = $query . " AND nombreTransaccion LIKE '%" . $transaccion . "%'";
