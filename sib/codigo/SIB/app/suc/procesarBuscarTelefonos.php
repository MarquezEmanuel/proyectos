...
$query = "SELECT * FROM [3telefonosTarjetas] WHERE sucursal = {$_SESSION['sucursal']}";

if (isset($cliente) && $cliente != null) {
    $query = $query . " AND numeroCliente LIKE '%" . $cliente . "%'";
    ...
    if ($filas) {
        ...
        <table id='tb_buscar_telefonos' class='table table-striped table-bordered' border='3' style='width: 100%'>
                                    ...
                                    <thead style='background-color:#024d85;color:white;'>
                                        <tr>
                                            <th style='display:none;'>Numero de sucursal</th>
