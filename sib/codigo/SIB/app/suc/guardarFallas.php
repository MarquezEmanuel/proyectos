...
$sql = "UPDATE [3fallas] SET comentario = '$comentario' WHERE id = " . $idCuenta;
            ...
            <div class="container">
                ...
                <div class="form-row align-items-center mx-auto">
                    ...
                    <div class="col-lg-8 text-center">
                        <a href="formFallas.php"><input type="button" class="btn btn-lg btn-dark btn-block" id="" name="" value="Ver Fallas de caja de la fecha"></a>
                    </div>
                    <div class="col-lg-2 text-center">
                    </div>
                </div>
                ...
                <div class="form-row align-items-center mx-auto">
                    ...
                    <div class="col-lg-8 text-center">
                        <a href="formBuscarFallas.php"><input type="button" class="btn btn-lg btn-dark btn-block" id="" name="" value="Buscar Fallas de caja"></a>
                    </div>
                    <div class="col-lg-2 text-center">
                    </div>
                </div>
