...
function morasCPD() {
    ...
    $sql = "SELECT *,convert(varchar,cast(deuda as money),1) AS deuda2 FROM [3morasCPD] WHERE sucursal = {$_SESSION['sucursal']} AND fechaActualizacion between '{$actual}' AND '{$actualfinal}'";
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div id="contenido" name="contenido" class="col-lg-12 contenido1">
                        ...
                        <br>
                        <a href="formBuscarMorasCPD.php"><input type="button" class="btn btn-dark" id="" name="" value="Busqueda Avanzada"></a>
                        &nbsp;
