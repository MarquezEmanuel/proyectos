...
$sql = "UPDATE [3cuentasInhabilitadas] SET comentario = '$comentario' WHERE id = " . $idCuenta;
...
if ($consulta) {
    ...
    $log = new Log();
    $log->writeLine("[Error al guardar comentario de cuentacorrentistas en forma manual][QUERY: $sql]");
    function mensaje() {
        $html = '
            ...
            <div class="container">
                ...
                <div class="form-row align-items-center mx-auto">
                    ...
                    <div class="col-lg-8 text-center">
                        <a href="formCentralCuentacorrentista.php"><input type="button" class="btn btn-lg btn-dark btn-block" id="" name="" value="Ver Cuentacorrentistas inhabilitados de la fecha"></a>
                    </div>
                    <div class="col-lg-2 text-center">
                    </div>
                </div>
                ...
                <div class="form-row align-items-center mx-auto">
                    ...
                    <div class="col-lg-8 text-center">
                        <a href="formBuscarCuentacorrentista.php"><input type="button" class="btn btn-lg btn-dark btn-block" id="" name="" value="Buscar Cuentacorrentistas inhabilitados"></a>
                    </div>
                    <div class="col-lg-2 text-center">
                    </div>
                </div>
