...
<div class="card-header">
    <div id="contenido">
        <h3 class="text-center"><u>Inventario de lineas no propias</u></h3>
		<br>
        <div id="centro" class="container">
            <form id="formBuscarCobranzasTC" name="formBuscarCobranzasTC" method="POST">
				...
				<div class="col">
                    ...
                    <div class="col">
                        <label class="mr-sm-2">Dias de Mora:</label> 
                        <input type="number" class="form-control" 
                               id="plazo" name="plazo"
                               placeholder="Plazo en dias">
                    </div>
                    <div class="col">
                        <label class="mr-sm-2">Dias de Mora:</label> <br>
                ...
                <div class="row">
                    <div class="col">
                        <div class="text-center">
                            ...
                            &nbsp;
                            <a href="inventarioNoPropias.php"><input type="button" class="btn btn-dark" id="" name="" value="Cancelar"></a>
                             &nbsp;
...
$(document).ready(function () {
	...
	$('#tb_buscar_cobranzasTC').DataTable({
                    ...
                    buttons: [
                        {   extend: 'excelHtml5',
                            title: 'Inventario cuentas no propias'
                        },
                    ],
    ...
    $("#contenido").on("click", "#btnBuscar", function () {
        $.ajax({
            type: "POST",
            url: "procesarBuscarInventarioNoPropias.php",
