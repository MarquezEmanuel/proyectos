...
if (isset($_POST['cbCorreos'])) {
    ...
    foreach ($correos as $correo) {
		$queryCorreo = "select rec.nombreCliente, rec.marca, convert(varchar,cast(rec.mtoTotalMoraTC as money),1) AS deuda, cor.correo
						...
						where rec.marca is not null AND cor.correo LIKE '{$correo}'";
                    ...
                    <table width='50%' border='0' style='font-family:Myriad Pro; font-size:14px'>
                        ...
                        <tbody>
                            <tr align='justify'>
								...
								por lo que le solicitamos efectúe el pago del mismo dentro de las 48 hs. hábiles siguiente, a través de los  Medios Electrónicos disponible o pago en su sucursal más cercana.
								El saldo vencido a la fecha es {$saldo} .
