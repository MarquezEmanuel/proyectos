...
if ($nombreRol != "RECUPERACION CREDITICIA") {
    $log = new Log();
...
<html id="html">
    ...
    <navbar id="menu-horizontal" class="navbar navbar-expand-lg navbar-dark" style="background-color: #07385c;">
        <div class="container">
            <span><img src="../../lib/img/cabezera.png" class="img-thumbnail" alt="Responsive image" width="70" height="70"></a></span>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        &nbsp;&nbsp;<h3 class="text-white">Recuperacion Crediticia</h3>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                    </ul>
