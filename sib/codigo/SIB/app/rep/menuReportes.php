...
if (!$resultadoRol) {
    ...
    $_SESSION['mensajeLogin'] = "<div class='alert-danger text-center' role='alert'>No se obtuvo información asociada al rol para cargar menu de reportes</div>";
...
<html id="html">
    ...
    <navbar id="menu-horizontal" class="navbar-bsc navbar navbar-expand-lg " style="background-color: #024d85;">
        <a class="navbar-brand" href="inicioReportes.php">
            <span><a href="inicioReportes.php"><img src="../../lib/img/logoBSCTrans.png" class="img-thumbnail" alt="Responsive image"></a></span>
        </a>
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto" >
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle " style="color: white;" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Gestión de reportes </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown" >
                            <a class="dropdown-item" href="inicioRTE.php">RTE</a>
                            <a class="dropdown-item" href="inicioRTEPF.php">RTE - PF</a>
                            <a class="dropdown-item" href="inicioRTEOC.php">RTE - OC</a>
                            <a class="dropdown-item" href="cargarCuentaComitente.php">Cuenta Comitente</a>
							<a class="dropdown-item" href="inicioXMLAltas.php">Altas XML</a>
                        </div>
                    </li>
                </ul>
