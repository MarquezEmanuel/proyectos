...
<div class="card-header">
    <h4 class="text-center p-4">CREAR RTE - PLAZO FIJO</h4>
                ...
                <div class="form-group row">
                    ...
                    <div class="col">
                        <input type="text" class="form-control" 
                               ...
                               title="Cuenta inversora asociada a la transacción [0-9]{2}-[0-9]{6}/[0-9]" required>
                    </div>
            ...
            <fieldset id="datos" class="add border p-2" style="border-color: #b9b9b9 !important;">
                ...
                <fieldset class="border p-2" style="border-color: #b9b9b9 !important;"  name="1">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-sm-2 col-form-label" title="Campo obligatorio">* Relación producto:</label> 
                        <div class="col" >
                ...
                <div class="form-group row">
                    <div class="col text-right" >
                        <button class='btn btn-outline-dark' id="agregar"> AGREGAR SUJETO VINCULADO </button>
                    </div>
                </div>
            </fieldset>
            <BR>
            <div class="row">
                <div class="col">
                    <div class="text-center">
                        ...
                        <a href="inicioRTEPF.php"><input type="button" class="btn btn-outline-secondary" value="Cancelar"></a>
                    </div>
                </div>
            </div>   
        </form>
...
<script type="text/javascript" src="../../lib/JQuery/CrearRTEPF.js"></script>
