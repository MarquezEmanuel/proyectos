...
<div class="card-header">
    <h4 class="text-center p-4">CREAR CUENTA COMITENTE - BAJA Cliente</h4>
    <div id="contenido" class="container">
        
        <form id="formBajaCliente" name="formBajaCliente" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col">
                        <select class="form-control" id="tipoAccion" name="tipoAccion" title="tipo de accion">
                            <option value="Cierre de cuenta">Cierre de cuenta</option>
                            <option value="Baja de condóminos u otros sujetos">Baja de condóminos u otros sujetos</option>
                        </select>
                    </div>
                </div>
...
<script type="text/javascript" src="../../lib/JQuery/cuentaComitenteBajaCliente.js"></script>
</html>