...
<div class="card-header">
    <div id="contenido">
        <h3 class="text-center"><u>Resumen de Transacciones</u></h3>
		<br>
                ...
                <div class="row">
                    <div class="col">
                        <div class="text-center">
                            ...
                            &nbsp;
                            <a href="resumen.php"><input type="button" class="btn btn-dark" id="" name="" value="Cancelar"></a>
                             &nbsp;
