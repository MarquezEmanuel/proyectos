...
<div class="card-header">
    <div id="contenido">
        <h3 class="text-center"><u>Maestro de Tarjetas</u></h3>
        <br>
        <div id="centro" class="container">
            <form id="formBuscarMoraTarjetas" name="formBuscarMoraTarjetas" method="POST">
                <div class="row">
					...
					<div class="col">
                        <label class="mr-sm-2">Estado de Tarjeta:</label> 
                        <select name="estado[]" id="estado" class="form-control mb-2" title="Estado de la Tarjeta">
				...
				<div class="row">
					<div class="col">
                        <label class="mr-sm-2">Numero de Tarjeta:</label> 
                        <input type="number" class="form-control" 
                               id="tarjeta" name="tarjeta"
                               placeholder="Numero de Tarjeta" title="tarjeta">
                    </div>
                    <div class="col">
                ...
                <div class="row">
                    <div class="col">
                        <div class="text-center">
                            ...
                            &nbsp;
                            <a href="tarjetas.php"><input type="button" class="btn btn-dark" id="" name="" value="Cancelar"></a>
                             &nbsp;
...
$(document).ready(function () {
    ...
    $("#contenido").on("click", "#btnBuscarMoraTarjetas", function () {
        $.ajax({
            type: "POST",
            url: "procesarBuscarTarjetas.php",
