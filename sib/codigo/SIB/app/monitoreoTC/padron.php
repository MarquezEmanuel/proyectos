...
<div class="card-header">
    <div id="contenido">
        <h3 class="text-center"><u>Padron</u></h3>
        <br>
        <div id="centro" class="container">
            <form id="formBuscarMoraTarjetas" name="formBuscarMoraTarjetas" method="POST">
                <div class="row">
                    ...
                    <div class="col">
                        <label class="mr-sm-2">Fecha Alta:</label> <br>
                ...
                <div class="row">
                    <div class="col">
                        <div class="text-center">
                            ...
                            &nbsp;
                            <a href="padron.php"><input type="button" class="btn btn-dark" id="" name="" value="Cancelar"></a>
                             &nbsp;
