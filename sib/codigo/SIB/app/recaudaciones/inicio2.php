...
<div class="card-header" id="FormBuscarRTE">
    <div id="contenido">
		...
		<u>Clientes Fallecidos Con Cuenta Anses</u>
        ...
        <div class="container">
			...
			<br>
                <div class="form-group row">
                    <div class="col">
                        <label class="mr-sm-2" title="Campo no obligatorio">Producto:</label> 
                        <input type="number" class="form-control" 
                               id="producto" name="producto"
                               placeholder="Numero de Producto">
                    </div>
                    <div class="col">
                        <label class="mr-sm-2" title="Campo obligatorio">Sucursal:</label> 
                        <input type="number" class="form-control"
                               id="sucursal" name="sucursal"
                               placeholder="Numero de Sucursal">
                    </div>
                    <div class="col">
                        <label class="mr-sm-2" title="Campo obligatorio">Nombre de Cliente:</label> 
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#tablaRTE').DataTable({
                    ...
                    buttons: [{
                            extend: 'excelHtml5',
                            title: 'Clientes Fallecidos Con Cuenta Anses'
                        }
                    ],
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body" id="mensaje">
				<em align="center">Este reporte busca todos los clientes fallecidos que posean productos ANSES y saldo en cuentas activas.</em>
				<br><br>
				<em align="center">A partir de esta informacion se puede generar el archivo PMCRED_DEB.txt para debitar el saldo.</em>
			</div>
            <div class="modal-footer">
                <input type='submit' class='btn btn-outline-secondary' data-dismiss="modal" value='Aceptar'>
            </div>
