...
/* CONSULTA TODOS LOS ESTADOS QUE SE ENCUENTREN EN LA BASE DE DATOS */
...
<div class="card-header">
    <div id="contenido">
        <h4 class="text-center p-4">CONSULTAR GARANTIAS</h4>
        <div id="centro" class="container">
            <form id="formConsultarGtia" name="formConsultarGtia" method="POST">
                <?php 
                if($estados && sqlsrv_has_rows($estados)) {
                    echo '<div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="number" class="form-control" 
                                   id="numSav" name="numSav" min="1"
                                   placeholder="SAV" title="N&uacute;mero de valor no numerario(SAV)">
                        </div>
                        <div class="col">
                    ...
                    echo'        </select>
                        ...
                        <div class="col">
                            ...
                            <input type="number" class="form-control" 
                                   id="numNroCliente" name="numNroCliente" min="1"
                                   placeholder="N&uacute;mero de cliente" title="N&uacute;mero de cliente">
                        </div>
                        <div class="col">
                            <label class="mr-sm-2">Nombre de cliente:</label> 
                            <input type="text" class="form-control" id="txtNomCliente" name="txtNomCliente" placeholder="Nombre de cliente" title="Nombre de cliente">
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="text-center">
                                <input type="submit" class="btn btn-success" id="btnConsultarGtia" name="btnConsultarGtia" value="Consultar">
                                <a href="formConsultarGarantia.php"><input type="button" class="btn btn-outline-secondary" value="Cancelar"></a>
                            </div>
                        </div>
                    </div>';
                } else {
...
<script type="text/javascript" charset="utf8" src="../../lib/JQuery/ConsultarGarantia.js"></script>
</html>