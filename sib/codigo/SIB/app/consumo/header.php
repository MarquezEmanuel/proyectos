...
<html id="html">
    ...
    <navbar id="menu-horizontal" class="navbar navbar-expand-lg navbar-dark" style="background-color: #363663;">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        &nbsp;&nbsp;<h3 class="text-white">Banca de Consumo</h3>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                    </ul>
                    ...
                    <a href="../procesarLogout.php"><input type="button" class="btn btn-secondary my-2 my-sm-0 text-dark" value="Salir" style="background-color:#d8d8e3"></a>
                </form>
                </div>
            </div>
        </div>
