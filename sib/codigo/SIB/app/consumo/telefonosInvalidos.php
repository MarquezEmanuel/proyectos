...
<div class="card-header">
    <div id="contenido">
        <h3 class="text-center"><u>Clientes con telefonos invalidos</u></h3>
                ...
                <div class="row">
                    <div class="col">
                        <div class="text-center">
                            ...
                            &nbsp;
                            <a href="telefonosInvalidos.php"><input type="button" class="btn btn-dark" id="" name="" value="Cancelar"></a>
                             &nbsp;
...
$(document).ready(function () {
    ...
    $("#contenido").on("click", "#btnBuscarChequesCobrados", function () {
        $.ajax({
            type: "POST",
            url: "procesarBuscarTelefonosInvalidos.php",
