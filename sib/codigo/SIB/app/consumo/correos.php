...
<div class="card-header">
    <div id="contenido">
        <h3 class="text-center"><u>Clientes con correos validos</u></h3>
                ...
                <div class="row">
                    <div class="col">
                        <div class="text-center">
                            ...
                            &nbsp;
                            <a href="correos.php"><input type="button" class="btn btn-dark" id="" name="" value="Cancelar"></a>
                             &nbsp;
